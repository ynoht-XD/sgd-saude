...
def _today_dow_dom() -> int:
    wd = date.today().weekday()  # 0=segunda..6=domingo
...
def index():
    ...
    aproc_table = "atendimento_procedimentos" if _has_table(conn, "atendimento_procedimentos") else "atendimento_procedimento"
    ...
    if has_atend and _has_table(conn, "usuarios"):
        ...
        if col_data_at:
            ...
            atend_por_prof = [
                {"profissional": r[0], "qtd": int(r[1] or 0)}
